...
/**
 * <h1>WakaTime 언어 요약 도메인</h1>
 * 일자별 사용 언어별 코딩 시간 통계를 나타내는 도메인 객체
 *
 * <ul>
 *   <li><b>wakaId</b>: 사용자 ID (WakaTime)</li>
 *   <li><b>summaryDate</b>: 코딩 요약 일자</li>
 *   <li><b>name</b>: 프로그래밍 언어 이름</li>
 *   <li><b>totalSeconds</b>: 해당 언어로 코딩한 시간 (초)</li>
 *   <li><b>percent</b>: 전체 중 해당 언어의 시간 비율 (%)</li>
...
@Getter
@Builder
public class WakaSummaryLanguage {
